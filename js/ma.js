...
// const totalPlayTime = playtimes.reduce((totalTime,time) => totalTime + time);
...
// const totalAveragePlaytimePerGame = players.reduce((avarageTime, player) => avarageTime + player.playtime / player.gamesPlayed,0);
...
// const names1 = names.map(book => book.author);
// console.log(names1);

// const names2 = names1.sort();
// console.log(names2);
// console.log(names1);
...
//   return users.flatMap(friend => friend.friends).sort().filter((friend, index, array) => array.indexOf(friend) === index);
// };
// // Change code above this line
...
// objE.z = [7,8,9,10];
// console.log(objE);
// console.log(objE.z[1]);
// const objA = Object.create(objC);
// objA.a = 10;
...
class Car {
  ...
  set price(newPrice) {
    ...
    console.log(this.#price, Car.MAX_PRICE);
